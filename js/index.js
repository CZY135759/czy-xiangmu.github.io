    ...
    series: [
      {
        ...
        type: "bar",
        barWidth: "35%",
        data: [20.2, 15, 21.8, 19.3, 15, 17.8, 10.8],
        itemStyle: {
          barBorderRadius: 5
        }
      }
...
(function() {
  ...
  var data = {
    year: [
      [24, 40, 101, 134, 90, 230, 310, 230, 120, 230, 210, 120],
    ...
    series: [
      {
        ...
        data: [
          ...
          { value: 20, name: "0——10岁" },
          { value: 25, name: "60——70岁" },
          { value: 30, name: "70岁以上" },
          { value: 42, name: "50——60岁" }
        ],
...
function handleEmergency() {
  // 紧急联络功能
  const confirmCall = confirm('是否立即联系值班医生？');
  if (confirmCall) {
